...
Modeling of published atomoxetine-desipramine-DDI studies for model evaluation

## Repository files
Within this repository, we distribute a PK-Sim snapshot containing simulations of all published clinical studies used to evaluate the predictive performance of the atomoxetine and desipramine models regarding atomoxetine-desipramine-DDIs, including the respective observed data digitized from literature reports. The applied atomoxetine model has been published previously [1] and was adapted to include competitive inhibition of CYP2D6 and CYP3A4. 
